...
class SLASerializer(NetBoxModelSerializer):
    class Meta:
        model = models.SLA
        fields = ['pk', 'id', 'name', 'uuid', 'description', 'slo', 'business_owner_contact', 'business_owner_tenant', 'technical_contact', 'data_classification' ]
...
class SolutionRequestSerializer(NetBoxModelSerializer):
    class Meta:
        ...
        fields = ['pk', 'id', 'name', 'description', 'status', 'version', 'solution_type', 'design_contact', 'business_owner_contact', 'business_owner_tenant', 
...
class ServiceRequirementSerializer(NetBoxModelSerializer):
    class Meta:
        ...
        fields = [
            'pk', 'id', 'name', 'description', 'status', 'service_template', 'requirement_owner', 'service_slo',
             ]
...
class ServiceComponentSerializer(NetBoxModelSerializer):
    class Meta:
        ...
        fields = ['pk', 'id', 'name', 'description', 'status', 'version', 'service_deployment', 'service_requirement', 'content_object']
