...
SOLUTION_APP_PREMISE = 'application_premise'
SOLUTION_APP_CLOUD = 'application_cloud'
SOLUTION_APP_SASS = 'application_saas'
SOLUTION_APP_HYBRID = 'application_hybrid'
...
class SolutionRequest(NetBoxModel):
    ...
    service_owner_tenant = models.ForeignKey(Tenant, on_delete=models.SET_NULL, null=True,related_name='sd_service_owners', verbose_name='Service Owner Department')
    ...
    functional_area_sponsor_tenant = models.ForeignKey(Tenant, on_delete=models.SET_NULL, null=True,related_name='sd_fa_owners', verbose_name='Functional Area Sponsor')
    functional_sub_area_sponsor_tenant = models.ForeignKey(Tenant, on_delete=models.SET_NULL, null=True,related_name='sd_sfa_owners', verbose_name='Functional Sub-Area Sponsor')
...
class SolutionTemplate(NetBoxModel):
    ...
    business_owner_tenant = models.ForeignKey(Tenant, on_delete=models.SET_NULL, null=True,related_name='sot_business_owners', verbose_name='Business Owner Department')
    business_owner_contact = models.ForeignKey(Contact, on_delete=models.SET_NULL, null=True,related_name='sot_business_owners', verbose_name='Business Owner Contact')
    service_owner_tenant = models.ForeignKey(Tenant, on_delete=models.SET_NULL, null=True,related_name='sot_service_owners', verbose_name='Service Owner Department')
    service_owner_contact  = models.ForeignKey(Contact, on_delete=models.SET_NULL, null=True,related_name='sot_service_owners', verbose_name='Service Owner Contact')
    functional_area_sponsor_tenant = models.ForeignKey(Tenant, on_delete=models.SET_NULL, null=True,related_name='sot_fa_owners', verbose_name='Functional Area Sponsor')
    functional_sub_area_sponsor_tenant = models.ForeignKey(Tenant, on_delete=models.SET_NULL, null=True,related_name='sot_sfa_owners', verbose_name='Functional Sub-Area Sponsor')
    solution_type = models.CharField(max_length=55, null=True, choices=SOLUTION_CHOICES)
    version = models.CharField(max_length=50, null=True, help_text="Version of the solution request")
...
class ServiceDeployment(NetBoxModel):
    ...
    business_owner_tenant = models.ForeignKey(Tenant, on_delete=models.SET_NULL, null=True,related_name='sd_business_owners', verbose_name='Business Owner Department')
