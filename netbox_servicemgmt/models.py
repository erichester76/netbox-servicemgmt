...
class SolutionRequest(NetBoxModel):
    ...
    business_owner_tenant = models.ForeignKey(Tenant, on_delete=models.SET_NULL, null=True,related_name='sor_business_owners', verbose_name='Business Owner Department')
    business_owner_contact = models.ForeignKey(Contact, on_delete=models.SET_NULL, null=True,related_name='sor_business_owners', verbose_name='Business Owner Contact')
    service_owner_tenant = models.ForeignKey(Tenant, on_delete=models.SET_NULL, null=True,related_name='sor_service_owners', verbose_name='Service Owner Department')
    service_owner_contact  = models.ForeignKey(Contact, on_delete=models.SET_NULL, null=True,related_name='sor_service_owners', verbose_name='Service Owner Contact')
    functional_area_sponsor_tenant = models.ForeignKey(Tenant, on_delete=models.SET_NULL, null=True,related_name='sor_fa_owners', verbose_name='Functional Area Sponsor')
    functional_sub_area_sponsor_tenant = models.ForeignKey(Tenant, on_delete=models.SET_NULL, null=True,related_name='sor_sfa_owners', verbose_name='Functional Sub-Area Sponsor')
    ...
    slo = models.ForeignKey(SLO, on_delete=models.SET_NULL, null=True, related_name='sor_slo',verbose_name='Assigned SLO Profile')
