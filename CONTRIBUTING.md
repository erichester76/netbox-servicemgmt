...
Report bugs at https://github.com/erichester76/netbox-servicemgmt/issues.
...
The best way to send feedback is to file an issue at https://github.com/erichester76/netbox-servicemgmt/issues.
...
Ready to contribute? Here's how to set up `netbox-servicemgmt` for local development.

1. Fork the `netbox-servicemgmt` repo on GitHub.
2. Clone your fork locally

    ```
    $ git clone git@github.com:your_name_here/netbox-servicemgmt.git
    ```
...
3. The pull request should work for Python 3.8, 3.9, 3.10 and 3.11. Check
   https://github.com/erichester76/netbox-servicemgmt/actions
